            ...
            <div class="col-md-8">
                ...
                <card-component titulo="Busca de Carros">
                    ...
                    <template v-slot:rodape>
                        <button type="submit" class="btn btn-primary btn-sm float-left" @click="pesquisar()">
                            Pesquisar
                        </button>
                    </template>
                </card-component>
                        ...
                        <div class="form-group">
                            <input-container-component titulo="Modelo do Carro" id="carroModelo" id-help="carroModeloHelp"
                                ...
                                <select class="form-select" aria-label="numeroPortas" v-model="carroModelo">
                                    <option v-for="(item, key) in modelos.data" :key="key" :value="item[0]">
                                        {{ item[1] }}
                                    </option>
                                </select>
                            </input-container-component>
                ...
                <modal-component id="modalCarroEditar" titulo="Dados do Carro">
                    <template v-slot:conteudo>
                        <div class="form-group">
                            <input-container-component titulo="ID do Carro" id="idCarro" id-help="idCarroHelp">
                                <input type="number" class="form-control" id="idCarro" aria-describedby="idCarroHelp"
                            ...
                            <input-container-component titulo="Disponibilidade" id="disponibilidade"
                                id-help="disponibilidadeHelp" texto-ajuda="(Opcional) Informe a disponibilidade do carro">
                                <select class="form-select" aria-label="disponibilidade"
                    ...
                    <template v-slot:rodape>
                        <div class="btnDeletar">
                            ...
                            <button type="button" class="btn btn-primary m-1" @click="editar($store.state.item)">
                                Editar
                            </button>
                        </div>
                    </template>
                ...
                <modal-component id="modalCarroDeletar" titulo="Dados do Carro a ser removida">
                    ...
                    <template v-slot:rodape>
                        <div class="btnDeletar">
                            ...
                            <button type="button" class="btn btn-danger m-1" @click="deletar($store.state.item)">
                                Deletar
                            </button>
                        </div>
                    </template>
        ...
        salvar() {
            ...
            axios
                ...
                .then((response) => {
                    swal(
                        "Sucesso!",
                        `Carro ${this.placa} cadastrado com sucesso!`,
                        "success"
                    );
                    this.carregarCarros();
                })
