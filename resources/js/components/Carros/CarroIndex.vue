  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
          ...
          <template v-slot:conteudo>
            <table-component
              ...
              :titulos="{
                ...
                disponivel: { titulo: 'Disponibilidade', tipo: 'boolean' },
              }"
            >
            </table-component>
          </template>
        ...
        <modal-component
          id="modalCarroDeletar"
          titulo="Dados do Carro a ser removida"
        >
          <template v-slot:conteudo>
