  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
              ...
              <div class="col-10">
                <pagination-component>
                  <li
                    ...
                    v-for="(li, key) in clientes.links"
                    :key="key"
                    @click="paginacao(li)"
                  >
        ...
        <modal-component
          id="modalClienteDeletar"
          titulo="Dados do Cliente a ser removida"
        >
          <template v-slot:conteudo>
    ...
    salvar() {
      ...
      axios
        ...
        .then((response) => {
          swal(
            "Sucesso!",
            `Cliente ${this.novoCliente} cadastrado com sucesso!`,
            "success"
          );
          this.carregarClientes();
        })
    ...
    editar() {
      ...
      axios
        ...
        .then((response) => {
          swal(
            "Sucesso!",
            `Cliente ${this.$store.state.item.nome} editado com sucesso!`,
            "success"
          );
          this.carregarClientes();
        })
        .catch((errors) => {
          swal(
            "Erro!",
            `Ocorreu um erro na edição: ${errors.response}`,
            "error"
          );
          console.log(errors);
        });
      ...
      swal({
        ...
        if (willDelete) {
          ...
          axios
            ...
            .catch((errors) => {
              swal(
                `Erro, verifique se o cliente ${item.cliente} possui alguma locação em aberto.`,
                {
                  icon: "error",
                }
              );
