      ...
      <tbody>
        <tr v-for="(obj, chave) in dadosFiltrados" :key="chave">
          <td v-for="(valor, chaveValor) in obj" :key="chaveValor">
            ...
            <span v-if="titulos[chaveValor].tipo == 'attr'">{{
              valor.placa
            }}</span>
          ...
          >
            <button
              ...
              class="btn btn btn-primary btn-sm m-1"
            ...
            <button
              v-if="editar.visivel"
              class="btn btn btn-warning btn-sm m-1"
              title="Editar"
              @click="setStore(obj, dados)"
            ...
            <button
              v-if="deletar.visivel"
              class="btn btn btn-danger btn-sm m-1"
              title="Deletar"
              @click="setStore(obj, dados)"
              :data-bs-toggle="deletar.dataToggle"
              :data-bs-target="deletar.dataTarget"
            >
