    ...
    <modal-component id="modalMarca" titulo="Cadastro de Marca">
      <template v-slot:alerta>
        <alert-component
          ...
          conteudo="Marca cadastrada com sucesso."
          v-if="this.feedbackStatus == 'sucesso'"
        ></alert-component>
        <alert-component
          classe="danger"
          :feedback="feedbackMessage"
          conteudo="Ocorreu o(s) seguinte(s) erro(s) ao cadastrar a nova Marca: "
          v-if="this.feedbackStatus == 'erro'"
        ></alert-component>
      </template>
      <template v-slot:conteudo>
    ...
    salvar() {
      ...
      axios
        ...
        .then((response) => {
          swal(
            "Sucesso!",
            `Marca ${this.novaMarca} cadastrada com sucesso!`,
            "success"
          );
      ...
      swal({
        ...
        if (willDelete) {
          ...
          axios
            ...
            .catch((errors) => {
              swal(
                `Existem modelos associados a marca ${item.nome} no banco de dados.`,
                {
                  icon: "error",
                }
              );
    ...
    editar() {
      ...
      axios
        ...
        .then((response) => {
          swal(
            "Sucesso!",
            `Marca ${this.$store.state.item.nome} editada com sucesso!`,
            "success"
          );
        ...
        .catch((errors) => {
          swal(
            "Erro!",
            `Ocorreu um erro na edição da marca: erro ${errors.response.data.message}`,
            "error"
          );
